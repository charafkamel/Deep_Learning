...
## final to test
runai submit --image registry.rcp.epfl.ch/ee-559-charaf/my-toolbox:v0.2 --gpu 1 --pvc course-ee-559-scratch:/scratch --pvc home:/pvc/home test-job --command -- sh -c "cd ../../pvc/home/DeepLearning/Project/Deep_Learning/ && pip install flash-attn==2.7.3 && pip install sentencepiece && sleep 20000"